...
?>
    ...
    <meta name="keywords" content="wordsearch, wordsearch, Puzzle, free, play, Game, Word, Free, Online, Fun">
    <meta name="author" content="wordsearch-Online.eu">
    ...
    <?php } ?>
    <link rel="icon" type="image/x-icon" href="<?php echo $_SESSION['root']; ?>icons/favicon.ico">
</head>
<body>
<?php if($_SESSION['mobile'] == false) { ?>
<div id="fb_root"></div>
        ...
        <div id="content-wrapper">
                ...
                <div class="content-holder view">
                    ...
                    <div class="rules-box">
                       ...
                       <div class="move-box"> <h3 class="content-header-ultra-one">  <?php echo $game[14]; ?> </h3> </div>
