...
<?php if($_SESSION['mobile'] == false) { ?>
    ...
    <meta property=og:description content="Wordsearch Puzzle - The Online Game. This wordsearch game is free to play around the world! Made with love to enjoy young and old. Like nd share with friends!" />
...
<?php } ?>
    ...
    <meta name=keywords content="Disclaimer, wordsearch-online.eu, wordsearch-online">
    <meta name="author" content="wordsearch-game.com">
    <meta name="robots" content="index,follow">
    <meta name="revisit-after" content="7 days">
    <meta name="geo.placename" content="Pinneberg">
    <meta name="geo.region" content="DE-SH">
    <title>Wordsearch Puzzle Online - The Game | Disclaimer</title>
...
<div id="main-content-wrapper">
    <div id="page-head">
        <div id="headline">
            ...
            <a href="http://www.wordsearch-game.com" title="<?php echo $disclaimer_content[12]; ?>"><img class="logo"
                <?php
				...
				if($_SESSION['mobile'] == false) {
                    ...
                    if ($_SESSION['logged_in'] == true) {
                        echo '<a href="#logout-user" class="logout opener" title="' . $header_menu[6] . '">' . $form_button_value[2] . '</a>';
    ...
    <div id="main-content">
        ...
        <div id="menu-right">
            <ul>
                <?php if($_SESSION['logged_in'] === false) { ?>
                    <li><a href="#login-user" class="login opener " title="<?php echo $header_menu[9]; ?>"><?php echo $form_header[1]; ?></a></li>
			...
			<ul>
                ...
                <li><span class="green-color indent"><?php echo $menu_bottom[6]; ?></span></li>
                <?php if($_SESSION['logged_in'] === true) { ?>
                    <hr />
					<ul>
					<li><a href="#logout-user" class="logout opener" title="<?php echo $header_menu[6]; ?>"><?php echo $form_header[0]; ?></a></li>
					</ul>
                <?php } ?>
            </ul>
        </div>
        ...
        <div id="content-wrapper">
            ...
            <div class="content-box">
                <h1><?php echo $disclaimer_content[0]; ?></h1><hr />
                <div class="content-holder view">
                    <h2 class="content-header"><?php echo $disclaimer_content[1]; ?></h2>
                <h3 class="content-inner-header"><?php echo $disclaimer_content[2]; ?></h3>
                <p><?php echo $disclaimer_content[3]; ?></p>
                <h3 class="content-inner-header"><?php echo $disclaimer_content[4]; ?></h3>
                <p><?php echo $disclaimer_content[5]; ?></p>
                <h3 class="content-inner-header"><?php echo $disclaimer_content[6]; ?></h3>
                <p><?php echo $disclaimer_content[7]; ?></p>
                <h3 class="content-inner-header"><?php echo $disclaimer_content[8]; ?></h3>
                <p><?php echo $disclaimer_content[9]; ?></p>
                <h3 class="content-inner-header"><?php echo $disclaimer_content[10]; ?></h3>
                <p><?php echo $disclaimer_content[11]; ?></p>
            <?php if ($_SESSION['mobile'] == true) { ?>
                <hr />
                <div class="last-menu"><p class="content-menu2"><a href="http://www.wordsearch-game.com" title="<?php echo $menu_bottom[7]; ?>"><?php echo $menu_bottom[8]; ?></a></p></div>
                <div class="last-menu">
                    <p class="content-menu2"><a href="donate-for-wordsearch" title="<?php echo $menu_bottom[4]; ?>"><?php echo $menu_bottom[9]; ?></a></p>
